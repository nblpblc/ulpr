...
public class EnrichedEvent extends RawEvent {
	...
	public EnrichedEvent(RawEvent rawEvent, double temperature, List<String> conditions) {
	    this.subject = rawEvent.subject; 
	    this.verb = rawEvent.verb;
	    this.directObject = rawEvent.directObject;
	    this.context = new EnrichedContext(rawEvent.context.timestamp, temperature, conditions);
	}
	...
	public static final class EnrichedContext extends Context {
		...
		public EnrichedContext(String timestamp, double temperature, List<String> conditions) {
